...
const Notification = ({
  ...
  return toast.custom(
    (t) => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm rounded-xl shadow-center shadow-accent bg-base-100 p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2 z-10
        ${
